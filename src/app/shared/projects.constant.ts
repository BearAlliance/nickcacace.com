  ...
  static wood: IProject[] = [
    {
      ...
      description: `Just as I found myself in need of a new coffee table, I met a man who runs a sawmill for discarded wood. Cedar doesn't usually make for the best furnature, because it's so soft, but this has been holding up wonderfully. Photos coming soon!`
    },
    {
      title: 'Steamer trunk restoration',
      summary:
        'An old steamer trunk found in an attic, fully restored with all original hardware',
      description: `Based one some rough estimates it's approximately 100 years old. Using a wire wheel and some other abrasives I managed to strip off all those years of decay. A fresh coat of tinted sealer and a new fabric lining brought this beautiful piece back to life. Photos coming soon!`
    },
    {
      title: 'Open wardrobe',
      summary: 'My bedroom is a weird shape, so I made this to hold my cloths',
      description: `My new apartment is rather small, and since most of my stuff belongs in a garage anyway, I needed something more space efficient to hold my cloths so my bike parts could fit in the closet. Constructed of common pine, I build it with re-usable hardware so it can be easily disassembled and moved. Photos coming soon!`
    }
  ];
