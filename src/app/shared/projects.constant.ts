  ...
  static software: IProject[] = [
    {
      ...
      description: `You know how it is, they always make you sign an NDA for the fun stuff. All of my recent professional work is closed source and vital company IP, so I can't share it with you here, but you can go check out the fruits of my labor at AmericanExpress.com`,
      technologies: [
        'React',
        'TypeScript',
        'Jenkins CI',
